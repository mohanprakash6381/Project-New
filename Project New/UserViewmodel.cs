...
namespace Project_New
{
    public partial class UserViewmodel : Form
    {
        ...
        {
            textBox7.Text=(int.Parse(textBox6.Text)*int.Parse(textBox5.Text)).ToString();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            int x = db.userviewmodel(int.Parse(comboBox1.Text), textBox1.Text, int.Parse(textBox2.Text), textBox3.Text, textBox4.Text, int.Parse(textBox5.Text), int.Parse(textBox6.Text),int.Parse(textBox7.Text));
            MessageBox.Show(x + "userviewmodel sales Sucessfully");
            loadmodel();
        }
    }
}
